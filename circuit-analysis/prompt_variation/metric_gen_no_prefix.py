...
ADAPTER_PATHS = '../../fine-tuning/add_sub_nlp/checkpoints_no_prefix/'
...
if __name__ == '__main__':
    ...
    for graph_path in graph_paths:
        ...
        if int(checkpoint_id) in allowed_checkpoint_ids:
            ...
            ds = EAPDataset(f'../../fine-tuning/add_sub_nlp/datasets_csv_no_prefix/prompts_id_{prompt_id}/test.csv')
            dataloader = ds.to_dataloader(6)

            save_path = Path(f'metrics/07-07-25_no_prefix/prompt_template_{prompt_id}_{checkpoint_id}.json')
