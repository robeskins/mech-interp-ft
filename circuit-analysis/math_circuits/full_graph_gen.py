...
allowed_checkpoint_ids = [60,120,180,240,300]

if __name__ == '__main__':
    master_checkpoint_folder = Path('../../fine-tuning/maths/checkpoints/')
        ...
        for checkpoint_folder in checkpoint_folders:
            ...
            if int(checkpoint_id) in allowed_checkpoint_ids:
                ...
                if file_path.exists():
                    ...
                    ds = EAPDataset(f'../../fine-tuning/maths/datasets_csv/prompts_id_{prompt_template_id}/test.csv')
