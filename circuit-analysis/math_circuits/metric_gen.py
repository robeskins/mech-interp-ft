...
RUN_NAME = '14-07-25-new'
ADAPTER_PATHS = '../../fine-tuning/maths/checkpoints/'
percentage_flag = False

percentage_prunes = [0.01,0.02,0.05]
...
if __name__ == '__main__':
    ...
    for graph_path in graph_paths:        
        ...
        ds = EAPDataset(f'../../fine-tuning/maths/datasets_csv/prompts_id_{prompt_id}/test.csv')
        dataloader = ds.to_dataloader(6)

        save_path = Path(f'metrics/14-07-25-new/prompt_template_{prompt_id}_{checkpoint_id}.json')
