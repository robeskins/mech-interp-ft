...
for i in range(100, 601):
    results_folder = f'results-07-07-25/phase_1/function_data/checkpoint-{i}'
    ...
    adapter_path = f"../../fine-tuning/sequential-fine-tuning/checkpoints/function_data/checkpoint-{i}"
    model = load_model(
    ...
    ds = EAPDataset(f'../../fine-tuning/sequential-fine-tuning/dataset_csv/function_data/test.csv')
