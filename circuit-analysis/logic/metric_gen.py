...
RUN_NAME = '14-07-25'
ADAPTER_PATHS = '../../fine-tuning/logic/checkpoints/'
...
if __name__ == '__main__':
    ...
    for graph_path in graph_paths:        
        ...
        ds = EAPDataset(f'../../fine-tuning/logic/datasets_csv/prompts_id_{prompt_id}/test.csv')
        dataloader = ds.to_dataloader(6)

        save_path = Path(f'metrics/11-07-25/prompt_template_{prompt_id}_{checkpoint_id}.json')
