...
RUN_NAME = '14-07-25'
allowed_checkpoint_ids = [100,300,600]

if __name__ == '__main__':
    master_checkpoint_folder = Path('../../fine-tuning/logic/checkpoints/')
        ...
        for checkpoint_folder in checkpoint_folders:
            ...
            if int(checkpoint_id) in allowed_checkpoint_ids:
                ...
                if file_path.exists():
                    ...
                    ds = EAPDataset(f'../../fine-tuning/logic/datasets_csv/prompts_id_{prompt_template_id}/test.csv')
                    dataloader = ds.to_dataloader(3)    
