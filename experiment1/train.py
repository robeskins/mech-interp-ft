...
if __name__ == '__main__':
    #AddSub Task 2 epochs
    # main(tasks = ['AddSub','AddSubInv','CondAddSub'],
    #      dataset_root = 'add_sub_tasks_spaced',
    #      run_name = "add_sub_2_epochs_spacing",
    #      model_name = "EleutherAI/pythia-1.4b-deduped",
    #      lora_r = 32,
    #      lora_alpha = 64,
    #      save_steps = 27, #10 checkpoints
    #      max_steps = 270, #2 epochs 
    #      learning_rate = 3e-4,
    ...
    #      lora_r = 32,
    #      lora_alpha = 64,
    #      save_steps = 18, # 6 checkpoints 
    #      max_steps = 108, #0.8 epoch
    #      learning_rate = 3e-4,
    #      model_cache_dir = "/mnt/faster0/rje41/.cache/huggingface",
    #      checkpoint_cache_dir = "/mnt/faster0/rje41/checkpoints/experiment_1",
    #      per_device_train_batch_size = 8,
    ...
    #BaseAdd Task 4 epochs
    main(tasks = ['AddBase8','AddBase9','AddBase10'],
         dataset_root = 'base_tasks_2d',
         run_name = "base_4_epochs_200",
         model_name = "EleutherAI/pythia-1.4b-deduped",
         lora_r = 64,
         lora_alpha = 128,
         save_steps = 54, #10 checkpoints
         max_steps = 540, #4 epochs 
         learning_rate = 3e-4,
         model_cache_dir = "/mnt/faster0/rje41/.cache/huggingface",
         checkpoint_cache_dir = "/mnt/faster0/rje41/checkpoints/experiment_1",
         per_device_train_batch_size = 8,
    ...
    #BaseAdd Task 1.2 epochs
    main(tasks = ['AddBase8','AddBase9','AddBase10'],
         dataset_root = 'base_tasks_2d',
         run_name = "base_1_2_epochs_200",
         model_name = "EleutherAI/pythia-1.4b-deduped",
         lora_r = 64,
         lora_alpha = 128,
         save_steps = 36, #6 checkpoints
         max_steps = 216, #1.2 epoch
         learning_rate = 3e-4,
         model_cache_dir = "/mnt/faster0/rje41/.cache/huggingface",
         checkpoint_cache_dir = "/mnt/faster0/rje41/checkpoints/experiment_1",
         per_device_train_batch_size = 8,
